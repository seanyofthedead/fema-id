...
ASSUMPTIONS = [
    ...
    ("ASSUMP-14", "The transcript phrase 'appeal life cycle' is a transcription artifact for the PIIA assessment/annual life cycle — no appeals workflow exists in scope.", "REQ-012, REQ-018", "SME-13"),
...
SME_QUESTIONS = [
    ...
    ("SME-13", "roadmap", "Confirm assessment-cycle terminology/cadence vs the PIIA / OMB A-123 App. C regime; is 'appeal life cycle' anything real?", "REQ-018 · ASSUMP-09 · ASSUMP-14"),
