...
3. **In parallel:** push SME-01/03/05/11 (and new SME-23/24) to the FEMA contacts through the Friday check-in agenda — they are the same four blockers file 13 already names, plus two cheap add-ons that ride along.
