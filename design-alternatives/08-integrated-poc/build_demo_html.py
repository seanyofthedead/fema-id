...
# This is the 08-integrated-poc copy: inputs are read (never written) from the
# original solution-design dataset; output stays inside this directory.
SRC = HERE.parent.parent / "solution-design" / "fema-program-id-risk-assessment"
DATA = SRC / "data" / "synthetic"
RULES_YAML = SRC / "data" / "generator" / "rules.yaml"
